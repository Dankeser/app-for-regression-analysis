...
class RegisterFrame(ctk.CTkFrame, FrameChange, RegisterCheck):
    def __init__(self,master,user_data_instance:object):
        ...
        self.label=ctk.CTkLabel(self,text='Sign up',font=ctk.CTkFont(size=20))
        self.label.grid(row=0,column=0,columnspan=2,pady=20)

        self.vorname_label=ctk.CTkLabel(self,text='Name:',anchor='w')
        ...
        self.passwort2_label=ctk.CTkLabel(self,text='Password (again):',anchor='w')
        ...
        self.submit=ctk.CTkButton(self,text='create account',command=self.submit_callback)
        self.submit.grid(row=7,column=0,padx=(10,0),pady=30)

        self.zurueck = ctk.CTkButton(self, text='return', fg_color='#d42d2d', hover_color='#a12727',command=lambda: self.change_the_frame(self, self.master.loginframe),width=50)
