...
class LoginFrame(ctk.CTkFrame, FrameChange, LoginCheck, Content, PropertyMixin):
    def __init__(self,master,user_data_instance):
        ...
        self.login_button=ctk.CTkButton(self,text_color="gray100",text='login', command=self.button_callback)
        self.login_button.grid(row=5,column=0,padx=10,pady=(10))

        self.register_button=ctk.CTkButton(self,text_color="gray100",text='create a account',command=lambda:self.change_the_frame(self,self.master.registerframe),fg_color=('gray50','gray15'),hover_color=('gray60','gray20'))
